...
* \tparam string utf8string Name of string to be entitized.
* \type string
...
/*!
* This method sets a username and password for specified proxy server.
* \tparam string host Host and port for proxy (port optional).
* \tparam string realm Realm of authentication.
* \tparam string username Username for proxy server.
* \tparam string password Password for proxy server.
*/
App.prototype.setProxyCredentials = function(host, realm, username, password)
{
   var methodBinding = {
