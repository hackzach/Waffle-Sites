...
if (xmlhttp!=null)
  ...
  {
  document.write("Your browser does not support this framework.");
  }
}
...
if (xmlhttp.readyState==4)
  ...
  if (xmlhttp.status==200)
    {// 200 = "OK"
    document.getElementById("new_frame").innerHTML=xmlhttp.responseText;
...
eval("page" = window.open(url, 'RWave Chicago', 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width='+width+',height='+height);");
}
